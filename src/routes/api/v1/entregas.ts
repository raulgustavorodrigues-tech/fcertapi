    ...
    handlers: {
      ...
      GET: async ({ request }) => {
        ...
        let q = supabaseAdmin
          .from("entregas_sync")
          .select(
            "cdfilentg, nrentg, dtentg, cdreg, periodo, cdclides, nomecli, nrtel, nrcep, endrf, endnr, endcp, bairr, munic, unfed, cdfilentgdes, qtform, flagentg, obsentg, vrrcb, vrtot, vrtxa, synced_at",
            { count: "exact" },
          )
